...
wrapOne ::
  { dat :: SyntaxData, lefts :: Array Syntax, rights :: Array Syntax } ->
  Syntax -> Syntax
wrapOne { dat, lefts, rights } syn =
  fromGenSyntax
    { dat: dat
    , syns: reverse lefts <> [ syn ] <> rights
    }
...
wrapOneTopOfPath toWrap (Zip pieces) = Zip pieces { up = wrapOneTopOfPath toWrap pieces.up }
